...
const csvToJson = require('../js/chicagoCrimeTheft.js');
const expectedLineJSON = require('../outputdata/chicagoCrimeJSON1.json');
const actualLineJSON = require('../outputdata/chicagoCrimeJSON1.json');
